...
**Retention bundle (2026-07-03, same session):** today's action rotates to the next undone action (walks the pool from the daily index); onboarding lands the user directly in their first action she