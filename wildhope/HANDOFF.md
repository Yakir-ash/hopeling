...
- **Current versions:** app shell `APP_V v25` / SW cache `wildhope-v25`; content.json `version 5` (39 actions, 7 courses, 17 facts, 22 categories, hand-curated `news[]`).
...
**Impact calculator (2026-07-03, same session):** Me tab → "🔮 Impact calculator" sheet. Habit simulator (any action × frequency → yearly impact with tangible equivalences: CO₂→km driven, plastic�