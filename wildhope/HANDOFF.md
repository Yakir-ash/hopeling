...
- **Current versions:** app shell `APP_V v33` / SW cache `wildhope-v33`; content.json `version 10` (39 actions, 7 courses, 21 lessons, 17 facts, 26 categories, hand-curated `news[]`).
