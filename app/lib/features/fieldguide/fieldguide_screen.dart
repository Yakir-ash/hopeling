...
class _FieldGuideScreenState extends State<FieldGuideScreen> {
  ...
  Widget _noteCard(FieldNote n) {
    // lab guesses are remembered by the Lab itself, not written
    // here (Yakir's call) - any old 'lab:' entries fall through
    // to the chapter lookup and quietly render nothing
