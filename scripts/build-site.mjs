...
.pagehero.sky-dawn{background:linear-gradient(180deg,#fff3dd,var(--paper) 65%)}
.pagehero.sky-day{background:linear-gradient(180deg,#e9f6ef,var(--paper) 65%)}
.pagehero.sky-dusk{background:linear-gradient(180deg,#ffe9d4,var(--paper) 65%)}
.pagehero.sky-night{background:linear-gradient(180deg,#e3e9f3,var(--paper) 65%)}
